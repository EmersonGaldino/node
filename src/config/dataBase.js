...
INSERT INTO usuarios (
    ...
    email,
    senha
) SELECT 'Emerson Galdino', 'galdino@partnergroup.com.br', '123' WHERE NOT EXISTS (SELECT * FROM usuarios WHERE email = 'galdino@partnergroup.com.br')
`;
...
INSERT INTO livros (
    ...
    preco,
    descricao
) SELECT 'Livro do jamelão ', 40.0, 'Como desenvolver com jamelão.' WHERE NOT EXISTS (SELECT * FROM livros WHERE titulo = 'Livro do jamelão ')
`;
